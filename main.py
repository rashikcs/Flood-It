...
class TestfirstStep(unittest.TestCase):
    ...
    def test_create_board_method(self):
        ...
        """
        self.assertEqual(
            self.FloodItGame_test_1.get_board(),
        ...
        self.assertEqual(
            self.FloodItGame_test_2.get_board(),
    ...
    def test_get_connected_neighbour_method(self):
        ...
        colored_board, visited, origin_color = self.FloodItGame_test_1.change_colors(
        ...
        colored_board, _, _ = self.FloodItGame_test_1.change_colors(x=1,
                                                                    ...
                                                                    chosen_color=1)
        self.assertEqual(
            self.FloodItGame_test_1.get_connected_tiles(
                x=0, y=0, matrix=colored_board), 4)

        # Testing for board with 4 colors
        colored_board, visited, origin_color = self.FloodItGame_test_2.change_colors(
            x=0, y=1, visited_tiles=[], chosen_color=1)
        colored_board, _, _ = self.FloodItGame_test_2.change_colors(x=1,
                                                                    ...
                                                                    chosen_color=1)
        self.assertEqual(
            self.FloodItGame_test_2.get_connected_tiles(
